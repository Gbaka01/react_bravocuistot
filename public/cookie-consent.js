/*!
 * Bandeau de consentement cookies — bravocuistot-goli.fr (GOLI Gore Gbaka)
...
(function () {
  ...
  /* ========= CONFIGURATION ========= */
  var CONFIG = {
    siteName: "bravocuistot-goli.fr",
    storageKey: "bravocuistot_consent",
    version: 1,                              // incrémenter si les catégories changent → redemande le consentement
    maxAgeDays: 182,                         // 6 mois (recommandation CNIL)
    privacyUrl: "/mentions#cookies",     // route React de la page Mentions légales, section Cookies
    accent: "#b45309",                       // couleur principale du site (à adapter)
    categories: [
      {
        id: "essentiels",
        label: "Essentiels",
    ...
    wrap = el(
      '<div class="cc-wrap" role="dialog" aria-modal="false" aria-labelledby="cc-title" aria-describedby="cc-desc">' +
        '<div class="cc-box">' +
          ...
          '<p id="cc-desc">' + CONFIG.siteName + ' utilise des cookies de mesure d\'audience (Google Analytics) pour savoir quelles recettes sont les plus consultées. ' +
